class AddRank extends eui.Component{
	public main:eui.Group;
	public rankfortune:eui.Image;
	public rankconsume:eui.Image;
	public ranksearch:eui.Image;
	public rankrowscroller:eui.Group;
	public ranktype:eui.Label;
	...
	public constructor(type:number) {
		...
		this.init(type);
		this.rankfortune.addEventListener(egret.TouchEvent.TOUCH_TAP, ()=>{this.chooseType(0)}, this);
		this.rankconsume.addEventListener(egret.TouchEvent.TOUCH_TAP, ()=>{this.chooseType(1)}, this);
		this.ranksearch.addEventListener(egret.TouchEvent.TOUCH_TAP, ()=>{this.chooseType(2)}, this);
		...
		this.tools.ajax({
			...
			success:re=>{
				...
				for(let i = 0; i < data.length; i++){
					data[i]['rank'] = i + 1;
					let rankrow = new RankRow(data[i]);
					rankrow.y = i * 128;
