window.skins={};
	...
	function PlayPage() {
		...
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this.main_i(),this.franckgroup_i(),this.choose_i(),this.back_i(),this.mute_i(),this.setting_i(),this.parse_i()];
	}
	...
	function Shop() {
		_super.call(this);
		this.skinParts = ["bg","shop","mine","robotnext","mateiralnext","sale","buy","minemateiral","minemateiralp","shopmateiral","minerobot","shoprobot","totalword","total","close","main"];
