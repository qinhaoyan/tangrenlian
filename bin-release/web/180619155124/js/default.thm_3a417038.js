window.skins={};
                ...
                generateEUI.skins = {"eui.Button":"resource/eui_skins/ButtonSkin.exml","eui.CheckBox":"resource/eui_skins/CheckBoxSkin.exml","eui.HScrollBar":"resource/eui_skins/HScrollBarSkin.exml","eui.HSlider":"resource/eui_skins/HSliderSkin.exml","eui.Panel":"resource/eui_skins/PanelSkin.exml","eui.TextInput":"resource/eui_skins/TextInputSkin.exml","eui.ProgressBar":"resource/eui_skins/ProgressBarSkin.exml","eui.RadioButton":"resource/eui_skins/RadioButtonSkin.exml","eui.Scroller":"resource/eui_skins/ScrollerSkin.exml","eui.ToggleSwitch":"resource/eui_skins/ToggleSwitchSkin.exml","eui.VScrollBar":"resource/eui_skins/VScrollBarSkin.exml","eui.VSlider":"resource/eui_skins/VSliderSkin.exml","eui.ItemRenderer":"resource/eui_skins/ItemRendererSkin.exml"};generateEUI.paths['resource/franck/RankFranck.exml'] = window.RankFranck = (function (_super) {
	...
	function ShopFranck() {
		_super.call(this);
		this.skinParts = ["ischoose","con","content"];
	...
	_proto._Group1_i = function () {
		...
		t.top = 0;
		t.width = 283;
		t.elementsContent = [this._Image1_i(),this.ischoose_i(),this._Image2_i(),this.con_i(),this.content_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	function PlayPage() {
		_super.call(this);
		this.skinParts = ["main","franck_bg","francklast","francknext","scenegroup","scoller","franckgroup","back","choose","mute","setting","parse"];
		
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this.main_i(),this.franckgroup_i(),this.back_i(),this.choose_i(),this.mute_i(),this.setting_i(),this.parse_i()];
	}
	...
	function Shop() {
		_super.call(this);
		this.skinParts = ["bg","shop","mine","robotnext","mateiralnext","sure","minemateiral","minemateiralp","shopmateiral","minerobot","shoprobot","total","close","main"];
	...
	_proto.main_i = function () {
		...
		t.x = 958.06;
		t.y = 533.39;
		t.elementsContent = [this.bg_i(),this.shop_i(),this.mine_i(),this.robotnext_i(),this.mateiralnext_i(),this.sure_i(),this.minemateiralp_i(),this._Scroller1_i(),this._Scroller2_i(),this._Scroller3_i(),this._Label1_i(),this.total_i(),this.close_i()];
		return t;
	};
	...
	function Smelter() {
		_super.call(this);
		this.skinParts = ["compoundicon","dismentleicon","compoundsure","compoundlast","compoundnext","compound","dismentlesure","dismentlelast","dismentlenext","dismentle","close","main"];
